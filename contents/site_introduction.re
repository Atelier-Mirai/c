...
== @<href>{https://ja.wikipedia.org/wiki/メインページ,wikipedia}


言わずと知れた、インターネット上の百科事典です。コンピュータに関する用語も豊富に記載されており、学習に役立ちます。


== @<href>{http://qiita.com,Qiita}


プログラミング知識を共有しよう。


== @<href>{http://codezine.jp,Codezine}


開発者のための実装系Webマガジン


== @<href>{http://itpro.nikkeibp.co.jp,ITpro}
...
@<href>{http://www.backlog.jp/git-guide/intro/intro1_1.html,サルでもわかるGit入門}



また、ソフトウェア開発プロジェクトのための共有ウェブサービスとして、@<br>{}
* @<href>{https://github.com,GitHub}
* @<href>{https://bitbucket.org,Bitbucket}
が有名です。


== @<href>{http://dotinstall.com/lessons/basic_c,C言語入門 (全22回) - プログラミングならドットインストール}

== @<href>{https://ja.wikipedia.org/wiki/正規表現,正規表現}
...
@<href>{http://kojika17.com/2013/01/starting-markdown.html,文章作成やメモ書きにも便利、Markdown記法}  
...
@<href>{http://translate.weblio.jp,英語翻訳}  (http://translate.weblio.jp)


== @<href>{http://atok.com/indexb.html,ATOK}
