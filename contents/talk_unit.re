 ...
 * 1 ビット(bit)@<br>{}コンピュータで扱うことができる最小の情報量です。スイッチが入っている（＝１）か、切れている（＝０）かなど、２通りの状態を表すことができます。 ２進法の１桁分の情報量です。  
 * 
 * 
 ...
 * 1 バイト(Byte)@<br>{}半角文字１文字分（８ビット＝２進法の８桁分）の情報量です。@<br>{}
 ...
 * 2 バイト全角文字１文字分の情報量です。1 バイトでは 256通りの文字を区別することができましたが、「ひらがな」や「カタカナ」、「漢字」などから成り立つ日本語を表記するには、不十分です。
 * 
 * 
 ...
 * 
 * 
 * 2進数10桁(=2の10乗)で1024通りを表現できます。@<br>{}10進法で、1,000倍のことをｋ（キロ）といいます。1000 g は 1kg ですね。コンピュータの世界では、1024でひとまとめにして、1024 バイト のことを 1kB といいます。  
 * 
 * 
 ...
 * 1ギガバイト(GB) ＝ 1,024 メガバイト ＝ 1,048,576 キロバイト ＝ 1,073,741,824 バイト@<br>{}
 ...
 * 1テラバイト(TB) ＝ 1,024 ギガバイト ＝ 1,048,576 メガバイト ＝ 1,073,741,824 キロバイト ＝ 1,099,511,627,776 バイト@<br>{}
